---
page_id: "training_lms"
title_en: "Training Lms"
title_ar: "التدريب والتعلم"
domain: "admin"
navigation_group: "admin_org"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "training_lms"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/training_lms.html"]
view_sources: ["views/training_lms.html"]
api_sources: []
...
- Page ID: `training_lms`
- English: Training Lms
- Arabic: التدريب والتعلم
- Domain: `admin`; navigation group: `admin_org`
- Route: switchPage('training_lms') / views/training_lms.html
- Page type: PAGE

# 2. Business Purpose

Training LMS — hr/training (risk: medium, phase: phase6e)
...
User opens this page to work with the Training Lms workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/training_lms.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/training_lms.html
...
- UI → renderer: views/training_lms.html
...
The intended output is the page’s named Training Lms record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: التدريب والتعلم
- English label: Training Lms
...
- Canonical candidate: `training_lms` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `training_lms` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Training Lms workflow; the current 231/231 click audit is route activation evidence only.
...
- Training Lms workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

...
renderer_type: "view"
renderer_sources: ["views/real-estate.html"]
view_sources: ["views/real-estate.html"]
api_sources: []
...
- Route: switchPage('real-estate') / views/real-estate.html
- Page type: PAGE

# 2. Business Purpose

Real Estate vertical — vertical/real_estate (risk: medium, phase: phase6h)
...
User opens this page to work with the Real Estate workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/real-estate.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/real-estate.html
...
- UI → renderer: views/real-estate.html
...
The intended output is the page’s named Real Estate record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: العقارات
- English label: Real Estate
...
- Canonical candidate: `real-estate` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `real-estate` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Real Estate workflow; the current 231/231 click audit is route activation evidence only.
...
- Real Estate workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

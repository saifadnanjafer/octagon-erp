---
page_id: "sensor_management"
title_en: "Sensor Management"
title_ar: "إدارة المستشعرات"
domain: "resources"
navigation_group: "resources_devices"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "sensor_management"
parent_page: null
aliases: []
...
- Page ID: `sensor_management`
- English: Sensor Management
- Arabic: إدارة المستشعرات
- Domain: `resources`; navigation group: `resources_devices`
- Route: switchPage('sensor_management') / views/sensor_management.html
- Page type: PAGE

# 2. Business Purpose

Sensor management — iot/sensors (risk: medium, phase: build10)
...
User opens this page to work with the Sensor Management workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/sensor_management.html. Static source counts at baseline: 6 headings, 5 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 6 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Sensor Management record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: إدارة المستشعرات
- English label: Sensor Management
...
- Canonical candidate: `sensor_management` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `sensor_management` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Sensor Management workflow; the current 231/231 click audit is route activation evidence only.
...
- Sensor Management workspace presentation and its explicitly verified page-specific actions: ${pageKey}:view, ${pageKey}:edit, ${pageKey}:create, OctagonBuild10.exportCsv(, ${pageKey}:view.

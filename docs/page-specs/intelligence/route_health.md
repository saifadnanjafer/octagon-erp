---
page_id: "route_health"
title_en: "Route Health"
title_ar: "فحص صحة النظام"
domain: "intelligence"
navigation_group: "intelligence_core"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "route_health"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/route_health.html"]
view_sources: ["views/route_health.html"]
api_sources: []
...
- Page ID: `route_health`
- English: Route Health
- Arabic: فحص صحة النظام
- Domain: `intelligence`; navigation group: `intelligence_core`
- Route: switchPage('route_health') / views/route_health.html
- Page type: PAGE

# 2. Business Purpose

Route health — system/diagnostic (risk: medium, phase: phase6e)
...
User opens this page to work with the Route Health workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/route_health.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/route_health.html
...
- UI → renderer: views/route_health.html
...
The intended output is the page’s named Route Health record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: فحص صحة النظام
- English label: Route Health
...
- Canonical candidate: `route_health` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `route_health` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Route Health workflow; the current 231/231 click audit is route activation evidence only.
...
- Route Health workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

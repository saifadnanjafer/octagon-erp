---
page_id: "geofence_management"
title_en: "Geofence Management"
title_ar: "إدارة السياج الجغرافي"
domain: "resources"
navigation_group: "resources_fleet"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "geofence_management"
parent_page: null
aliases: []
...
- Page ID: `geofence_management`
- English: Geofence Management
- Arabic: إدارة السياج الجغرافي
- Domain: `resources`; navigation group: `resources_fleet`
- Route: switchPage('geofence_management') / views/geofence_management.html
- Page type: PAGE

# 2. Business Purpose

Geofence management — fleet/geofences (risk: medium, phase: build10)
...
User opens this page to work with the Geofence Management workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/geofence_management.html. Static source counts at baseline: 6 headings, 5 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 6 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Geofence Management record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: إدارة السياج الجغرافي
- English label: Geofence Management
...
- Canonical candidate: `geofence_management` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `geofence_management` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Geofence Management workflow; the current 231/231 click audit is route activation evidence only.
...
- Geofence Management workspace presentation and its explicitly verified page-specific actions: ${pageKey}:view, ${pageKey}:edit, ${pageKey}:create, OctagonBuild10.exportCsv(, ${pageKey}:view.

---
page_id: "device_center"
title_en: "Device Center"
title_ar: "مركز الأجهزة وإنترنت الأشياء"
domain: "admin"
navigation_group: "admin_org"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "device_center"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/device_center.html"]
view_sources: ["views/device_center.html"]
api_sources: []
...
- Page ID: `device_center`
- English: Device Center
- Arabic: مركز الأجهزة وإنترنت الأشياء
- Domain: `admin`; navigation group: `admin_org`
- Route: switchPage('device_center') / views/device_center.html
- Page type: PAGE

# 2. Business Purpose

Device center — admin/device (risk: high, phase: phase6e)
...
User opens this page to work with the Device Center workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/device_center.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/device_center.html
...
- UI → renderer: views/device_center.html
...
The intended output is the page’s named Device Center record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: مركز الأجهزة وإنترنت الأشياء
- English label: Device Center
...
- Canonical candidate: `device_center` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `device_center` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Device Center workflow; the current 231/231 click audit is route activation evidence only.
...
- Device Center workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

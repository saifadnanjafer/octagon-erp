...
renderer_type: "view"
renderer_sources: ["views/work_orders.html"]
view_sources: ["views/work_orders.html"]
api_sources: []
domain_sources: ["services/permissionService.js"]
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-09/downtime-workspaces-browser.test.mjs","tests/build-09/operational-production-quality-chromium.test.mjs","tests/build-09/production-fixture.mjs","tests/build-09/production-material-workspaces-browser.test.mjs","tests/build-09/quality-workspaces-browser.test.mjs","tests/build-09/shopfloor-downtime-domain.test.mjs","tests/build-09/shopfloor-workspaces-browser.test.mjs","tests/checkpoint-d-e/manufacturing_orders.test.mjs"]
...
- Route: switchPage('work_orders') / views/work_orders.html
- Page type: TRANSACTION

# 2. Business Purpose

Work Orders — workshop/production (risk: medium, phase: phase6h)
...
User opens this page to work with the Work Orders workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/work_orders.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/work_orders.html
...
- UI → renderer: views/work_orders.html
...
The intended output is the page’s named Work Orders record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: أوامر العمل
- English label: Work Orders
...
- Canonical candidate: `work_orders` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `work_orders` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Work Orders workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-09/downtime-workspaces-browser.test.mjs, tests/build-09/operational-production-quality-chromium.test.mjs, tests/build-09/production-fixture.mjs, tests/build-09/production-material-workspaces-browser.test.mjs, tests/build-09/quality-workspaces-browser.test.mjs, tests/build-09/shopfloor-downtime-domain.test.mjs, tests/build-09/shopfloor-workspaces-browser.test.mjs, tests/checkpoint-d-e/manufacturing_orders.test.mjs
...
- Work Orders workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

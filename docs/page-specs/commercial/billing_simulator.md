---
page_id: "billing_simulator"
title_en: "Billing Simulator"
title_ar: "محاكي الفوترة"
domain: "commercial"
navigation_group: "commercial_saas"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "billing_simulator"
parent_page: null
aliases: []
...
- Page ID: `billing_simulator`
- English: Billing Simulator
- Arabic: محاكي الفوترة
- Domain: `commercial`; navigation group: `commercial_saas`
- Route: switchPage('billing_simulator') / views/billing_simulator.html
- Page type: PAGE

# 2. Business Purpose

Billing simulator — commercial/billing (risk: high, phase: build11)
...
User opens this page to work with the Billing Simulator workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/billing_simulator.html. Static source counts at baseline: 5 headings, 6 button tags, 7 input/select/textarea controls, 1 tables, 1 forms, and 2 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Billing Simulator record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: محاكي الفوترة
- English label: Billing Simulator
...
- Canonical candidate: `billing_simulator` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `billing_simulator` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Billing Simulator workflow; the current 231/231 click audit is route activation evidence only.
...
- Billing Simulator workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

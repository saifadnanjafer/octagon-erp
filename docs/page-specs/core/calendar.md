...
page_id: "calendar"
title_en: "Calendar"
title_ar: "تقويم الدوام"
domain: "core"
navigation_group: "core_daily"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "calendar"
parent_page: null
aliases: []
roles: ["workshop.user"]
...
renderer_sources: ["views/calendar.html","modules/build12-workspaces.js"]
view_sources: ["views/calendar.html"]
...
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-12/build12-acceptance-contract.test.mjs","tests/checkpoint-c/canonical_work_management_ui.test.mjs","tests/checkpoint-c/work_item_lifecycle.test.mjs","tests/phase02/workflow-approvals.test.mjs","tests/phase03/finance-wave-d.test.mjs","tests/unit/sequences.test.mjs"]
...
- Route: switchPage('calendar') / views/calendar.html
- Page type: PAGE

# 2. Business Purpose

Attendance calendar — hr/payroll (risk: medium, phase: phase6e)
...
User opens this page to work with the Calendar workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/calendar.html. Static source counts at baseline: 5 headings, 8 button tags, 2 input/select/textarea controls, 2 tables, 1 forms, and 2 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/calendar.html
...
- UI → renderer: views/calendar.html
...
- UI label: NOT VERIFIED; handler/action ID: prevMonthCal(); permission and persisted result: NOT VERIFIED unless a page-specific API is listed above.
- UI label: اليوم; handler/action ID: calendarJumpToday(); permission and persisted result: NOT VERIFIED unless a page-specific API is listed above.
- UI label: مصاريف التشغيل; handler/action ID: openMonthlyOperatingCostsModal(); permission and persisted result: NOT VERIFIED unless a page-specific API is listed above.
- UI label: إغلاق الشهر; handler/action ID: toggleCalendarMonthClosed(); permission and persisted result: NOT VERIFIED unless a page-specific API is listed above.
- UI label: NOT VERIFIED; handler/action ID: nextMonthCal(); permission and persisted result: NOT VERIFIED unless a page-specific API is listed above.
...
The intended output is the page’s named Calendar record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: تقويم الدوام
- English label: Calendar
...
- Canonical candidate: `calendar` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `calendar` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Calendar workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-12/build12-acceptance-contract.test.mjs, tests/checkpoint-c/canonical_work_management_ui.test.mjs, tests/checkpoint-c/work_item_lifecycle.test.mjs, tests/phase02/workflow-approvals.test.mjs, tests/phase03/finance-wave-d.test.mjs, tests/unit/sequences.test.mjs
...
- Calendar workspace presentation and its explicitly verified page-specific actions: prevMonthCal(), calendarJumpToday(), openMonthlyOperatingCostsModal(), toggleCalendarMonthClosed(), nextMonthCal(), NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

...
page_id: "visitors"
title_en: "Visitors"
title_ar: "إدارة الزوّار والاستقبال"
domain: "resources"
navigation_group: "resources_knowledge"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "visitors"
parent_page: null
aliases: []
roles: ["workshop.user"]
...
renderer_type: "view"
renderer_sources: ["views/visitors.html"]
view_sources: ["views/visitors.html"]
api_sources: []
...
- Page ID: `visitors`
- English: Visitors
- Arabic: إدارة الزوّار والاستقبال
- Domain: `resources`; navigation group: `resources_knowledge`
- Route: switchPage('visitors') / views/visitors.html
- Page type: PAGE

# 2. Business Purpose

Visitor Logs — workshop/operations (risk: low, phase: phase6h)
...
User opens this page to work with the Visitors workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/visitors.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/visitors.html
...
- UI → renderer: views/visitors.html
...
The intended output is the page’s named Visitors record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: إدارة الزوّار والاستقبال
- English label: Visitors
...
- Canonical candidate: `visitors` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `visitors` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Visitors workflow; the current 231/231 click audit is route activation evidence only.
...
- Visitors workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

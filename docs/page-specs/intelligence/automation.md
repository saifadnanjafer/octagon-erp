...
page_id: "automation"
title_en: "Automation"
title_ar: "محرك الأتمتة"
domain: "intelligence"
navigation_group: "intelligence_core"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "automation"
parent_page: null
aliases: []
roles: ["system.admin"]
...
renderer_type: "view"
renderer_sources: ["views/automation.html"]
view_sources: ["views/automation.html"]
api_sources: []
domain_sources: ["services/permissionService.js"]
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/phase02/runtime-strangler.test.mjs","tests/phase02/workflow-approvals.test.mjs"]
...
- Route: switchPage('automation') / views/automation.html
- Page type: PAGE

# 2. Business Purpose

Automation engine — ai/system (risk: critical, phase: core)
...
User opens this page to work with the Automation workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/automation.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/automation.html
...
- UI → renderer: views/automation.html
...
The intended output is the page’s named Automation record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: محرك الأتمتة
- English label: Automation
...
- Canonical candidate: `automation` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `automation` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Automation workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/phase02/runtime-strangler.test.mjs, tests/phase02/workflow-approvals.test.mjs
...
- Automation workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

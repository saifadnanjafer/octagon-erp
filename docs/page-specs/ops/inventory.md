...
page_id: "inventory"
title_en: "Inventory"
title_ar: "المخزون والمواد"
domain: "ops"
navigation_group: "ops_inventory"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "inventory"
parent_page: null
aliases: []
roles: ["workshop.user"]
...
renderer_type: "view"
renderer_sources: ["views/inventory.html"]
view_sources: ["views/inventory.html"]
api_sources: []
domain_sources: ["services/permissionService.js"]
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-01/rma-foundation.test.mjs","tests/build-08/mps-sop-domain.test.mjs","tests/build-09/browser-harness.mjs","tests/build-09/count-workspaces-browser.test.mjs","tests/build-09/cross-domain-lifecycles.test.mjs","tests/build-09/cycle-counting-domain.test.mjs","tests/build-09/dock-crossdock-domain.test.mjs","tests/build-09/dock-workspaces-browser.test.mjs"]
...
- Page ID: `inventory`
- English: Inventory
- Arabic: المخزون والمواد
- Domain: `ops`; navigation group: `ops_inventory`
- Route: switchPage('inventory') / views/inventory.html
- Page type: PAGE

# 2. Business Purpose

Inventory and stock — workshop/inventory (risk: high, phase: core)
...
User opens this page to work with the Inventory workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/inventory.html. Static source counts at baseline: 1 headings, 1 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/inventory.html
...
- UI → renderer: views/inventory.html
...
- UI label: إضافة مادة; handler/action ID: addMaterial(); permission and persisted result: NOT VERIFIED unless a page-specific API is listed above.
...
The intended output is the page’s named Inventory record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: المخزون والمواد
- English label: Inventory
...
- Canonical candidate: `inventory` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `inventory` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Inventory workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-01/rma-foundation.test.mjs, tests/build-08/mps-sop-domain.test.mjs, tests/build-09/browser-harness.mjs, tests/build-09/count-workspaces-browser.test.mjs, tests/build-09/cross-domain-lifecycles.test.mjs, tests/build-09/cycle-counting-domain.test.mjs, tests/build-09/dock-crossdock-domain.test.mjs, tests/build-09/dock-workspaces-browser.test.mjs
...
- Inventory workspace presentation and its explicitly verified page-specific actions: addMaterial().

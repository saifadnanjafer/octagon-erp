...
- Page ID: `downtime_board`
- English: Downtime Board
- Arabic: لوحة التوقفات
- Domain: `ops`; navigation group: `ops_production`
- Route: switchPage('downtime_board') / views/downtime_board.html
- Page type: DASHBOARD

# 2. Business Purpose

Downtime board — workshop/production (risk: high, phase: build09)
...
User opens this page to work with the Downtime Board workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/downtime_board.html. Static source counts at baseline: 6 headings, 2 button tags, 2 input/select/textarea controls, 0 tables, 1 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Downtime Board record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.

# 10. Workflow Position

- Upstream: NOT VERIFIED from explicit workflow metadata.
- Downstream: `operational_performance`
...
- Arabic label: لوحة التوقفات
- English label: Downtime Board
...
- Canonical candidate: `downtime_board` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `downtime_board` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Downtime Board workflow; the current 231/231 click audit is route activation evidence only.
...
- Downtime Board workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED.

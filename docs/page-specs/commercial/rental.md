...
page_id: "rental"
title_en: "Rental"
title_ar: "تأجير المعدات"
domain: "commercial"
navigation_group: "commercial_verticals"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "rental"
parent_page: null
aliases: []
roles: ["workshop.user"]
...
renderer_type: "view"
renderer_sources: ["views/rental.html"]
view_sources: ["views/rental.html"]
api_sources: []
...
- Page ID: `rental`
- English: Rental
- Arabic: تأجير المعدات
- Domain: `commercial`; navigation group: `commercial_verticals`
- Route: switchPage('rental') / views/rental.html
- Page type: PAGE

# 2. Business Purpose

Rental Hub — workshop/operations (risk: medium, phase: phase6h)
...
User opens this page to work with the Rental workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/rental.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/rental.html
...
The intended output is the page’s named Rental record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: تأجير المعدات
- English label: Rental
...
- Canonical candidate: `rental` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `rental` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Rental workflow; the current 231/231 click audit is route activation evidence only.
...
- Rental workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

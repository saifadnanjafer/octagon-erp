...
renderer_type: "view"
renderer_sources: ["views/logistics.html"]
...
- Page ID: `logistics`
- English: Logistics
- Arabic: اللوجستيات والتوصيل
- Domain: `resources`; navigation group: `resources_supply`
- Route: switchPage('logistics') / views/logistics.html
- Page type: PAGE

# 2. Business Purpose

Logistics cargo — workshop/logistics (risk: medium, phase: phase6h)
...
User opens this page to work with the Logistics workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/logistics.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/logistics.html
...
- UI → renderer: views/logistics.html
...
The intended output is the page’s named Logistics record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: اللوجستيات والتوصيل
- English label: Logistics
...
- Canonical candidate: `logistics` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `logistics` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Logistics workflow; the current 231/231 click audit is route activation evidence only.
...
- Logistics workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

---
page_id: "sales_commission"
title_en: "Sales Commission"
title_ar: "العمولات"
domain: "commercial"
navigation_group: "commercial_sales"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "sales_commission"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/sales_commission.html"]
view_sources: ["views/sales_commission.html"]
api_sources: []
domain_sources: ["services/permissionService.js"]
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-06/commercial-operations-browser.test.mjs","tests/checkpoint-c/migration_046.test.mjs","tests/checkpoint-c/sales_lifecycle.test.mjs"]
...
- Page ID: `sales_commission`
- English: Sales Commission
- Arabic: العمولات
- Domain: `commercial`; navigation group: `commercial_sales`
- Route: switchPage('sales_commission') / views/sales_commission.html
- Page type: PAGE

# 2. Business Purpose

Sales commission — sales/commission (risk: high, phase: phase7j)
...
User opens this page to work with the Sales Commission workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/sales_commission.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/sales_commission.html
...
- UI → renderer: views/sales_commission.html
...
The intended output is the page’s named Sales Commission record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: العمولات
- English label: Sales Commission
...
- Canonical candidate: `sales_commission` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `sales_commission` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Sales Commission workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-06/commercial-operations-browser.test.mjs, tests/checkpoint-c/migration_046.test.mjs, tests/checkpoint-c/sales_lifecycle.test.mjs
...
- Sales Commission workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

---
page_id: "recall_analysis"
title_en: "Recall Analysis"
title_ar: "تحليل الاستدعاءات"
domain: "ops"
navigation_group: "ops_warehouse_traceability"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "recall_analysis"
parent_page: null
aliases: []
...
renderer_sources: ["modules/build09-trace-workspace.js"]
view_sources: []
api_sources: []
domain_sources: ["modules/build09-trace-workspace.js","services/permissionService.js"]
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-09/build09-workspaces-contract.test.mjs","tests/build-09/build09r2-bespoke-contract.test.mjs","tests/build-09/operational-32-page-matrix-chromium.test.mjs","tests/build-09/trace-workspaces-browser.test.mjs"]
...
- Page ID: `recall_analysis`
- English: Recall Analysis
- Arabic: تحليل الاستدعاءات
- Domain: `ops`; navigation group: `ops_warehouse_traceability`
- Route: switchPage('recall_analysis') / views/recall_analysis.html
- Page type: PAGE

# 2. Business Purpose

Recall analysis — workshop/quality (risk: critical, phase: build09)
...
User opens this page to work with the Recall Analysis workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/recall_analysis.html. Static source counts at baseline: 8 headings, 5 button tags, 2 input/select/textarea controls, 0 tables, 2 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: modules/build09-trace-workspace.js
...
- UI → renderer: modules/build09-trace-workspace.js
...
- UI label: ${esc(t('Propose holds', 'اقتراح الحجوزات'))}; handler/action ID: NOT VERIFIED; permission and persisted result: NOT VERIFIED unless a page-specific API is listed above.
...
The intended output is the page’s named Recall Analysis record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.

# 10. Workflow Position

- Upstream: NOT VERIFIED from explicit workflow metadata.
- Downstream: `lot_serial_traceability`
...
- Arabic label: تحليل الاستدعاءات
- English label: Recall Analysis
...
- Canonical candidate: `recall_analysis` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `recall_analysis` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Recall Analysis workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-09/build09-workspaces-contract.test.mjs, tests/build-09/build09r2-bespoke-contract.test.mjs, tests/build-09/operational-32-page-matrix-chromium.test.mjs, tests/build-09/trace-workspaces-browser.test.mjs
...
- Recall Analysis workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

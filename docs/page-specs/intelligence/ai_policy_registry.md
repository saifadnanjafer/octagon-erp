---
page_id: "ai_policy_registry"
title_en: "AI Policy Registry"
title_ar: "سجل سياسات الذكاء الاصطناعي"
domain: "intelligence"
navigation_group: "intelligence_governance"
kind: SETUP
canonical_status: PRIMARY
canonical_home: "ai_policy_registry"
parent_page: null
aliases: []
...
- Page ID: `ai_policy_registry`
- English: AI Policy Registry
- Arabic: سجل سياسات الذكاء الاصطناعي
- Domain: `intelligence`; navigation group: `intelligence_governance`
- Route: switchPage('ai_policy_registry') / views/ai_policy_registry.html
- Page type: SETUP

# 2. Business Purpose

AI policy registry — build12/ai-policy (risk: high, phase: build12)
...
User opens this page to work with the AI Policy Registry workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/ai_policy_registry.html. Static source counts at baseline: 2 headings, 3 button tags, 2 input/select/textarea controls, 1 tables, 1 forms, and 2 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named AI Policy Registry record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: سجل سياسات الذكاء الاصطناعي
- English label: AI Policy Registry
...
- **PAGE-ai_policy_registry-GAP-004** (P1, PERMISSION) — The review inventory flags this commercial/SaaS page as lacking a matching entitlement mapping in the disposable review database.
- **PAGE-ai_policy_registry-GAP-005** (P2, TEST) — Documentation contradiction: NAVIGATION_FORENSIC_REPORT.json records app.js switchPage, while the module registry also contains this page. Reconcile renderer ownership after Product Recovery.
...
- Canonical candidate: `ai_policy_registry` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `ai_policy_registry` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named AI Policy Registry workflow; the current 231/231 click audit is route activation evidence only.
...
- AI Policy Registry workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

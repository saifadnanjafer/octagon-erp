---
page_id: "firmware_catalogue"
title_en: "Firmware Catalogue"
title_ar: "دليل البرامج الثابتة"
domain: "resources"
navigation_group: "resources_devices"
kind: SETUP
canonical_status: PRIMARY
canonical_home: "firmware_catalogue"
parent_page: null
aliases: []
...
- Page ID: `firmware_catalogue`
- English: Firmware Catalogue
- Arabic: دليل البرامج الثابتة
- Domain: `resources`; navigation group: `resources_devices`
- Route: switchPage('firmware_catalogue') / views/firmware_catalogue.html
- Page type: SETUP

# 2. Business Purpose

Firmware catalogue — iot/firmware (risk: high, phase: build10)
...
User opens this page to work with the Firmware Catalogue workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/firmware_catalogue.html. Static source counts at baseline: 6 headings, 5 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 6 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Firmware Catalogue record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: دليل البرامج الثابتة
- English label: Firmware Catalogue
...
- Canonical candidate: `firmware_catalogue` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `firmware_catalogue` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Firmware Catalogue workflow; the current 231/231 click audit is route activation evidence only.
...
- Firmware Catalogue workspace presentation and its explicitly verified page-specific actions: ${pageKey}:view, ${pageKey}:edit, ${pageKey}:create, OctagonBuild10.exportCsv(, ${pageKey}:view.

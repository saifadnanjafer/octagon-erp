---
page_id: "canonical_console"
title_en: "Canonical Operations"
title_ar: "العمليات الموحّدة"
domain: "ops"
navigation_group: "ops_inventory"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "canonical_console"
parent_page: null
aliases: []
roles: ["workshop.manager","finance.manager","system.admin"]
permission: "workshop.manager, finance.manager, system.admin"
entitlement: "none/global (not a commercial/SaaS-gated page)"
renderer_type: "view"
renderer_sources: ["views/canonical_console.html"]
view_sources: ["views/canonical_console.html"]
api_sources: []
...
- Page ID: `canonical_console`
- English: Canonical Operations
- Arabic: العمليات الموحّدة
- Domain: `ops`; navigation group: `ops_inventory`
- Route: switchPage('canonical_console') / views/canonical_console.html
- Page type: PAGE

# 2. Business Purpose

Canonical Operations console — platform/canonical (risk: high, phase: visible-expansion)

# 3. Primary Users

- Declared roles: workshop.manager, finance.manager, system.admin
- Viewer/operator/reviewer/manager/administrator split: NOT VERIFIED beyond the declared permission gate.

# 4. Primary User Goal

User opens this page to work with the Canonical Operations workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/canonical_console.html. Static source counts at baseline: 1 headings, 1 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/canonical_console.html
...
- UI → renderer: views/canonical_console.html
...
The intended output is the page’s named Canonical Operations record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Client page gate: workshop.manager, finance.manager, system.admin
- Entitlement: none/global (not a commercial/SaaS-gated page)
...
- Arabic label: العمليات الموحّدة
- English label: Canonical Operations
...
- Canonical candidate: `canonical_console` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `canonical_console` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Canonical Operations workflow; the current 231/231 click audit is route activation evidence only.
...
- Canonical Operations workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

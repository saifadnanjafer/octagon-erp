---
page_id: "risk_compliance"
title_en: "Risk Compliance"
title_ar: "المخاطر والامتثال"
domain: "admin"
navigation_group: "admin_org"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "risk_compliance"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/risk_compliance.html"]
view_sources: ["views/risk_compliance.html"]
api_sources: []
...
- Page ID: `risk_compliance`
- English: Risk Compliance
- Arabic: المخاطر والامتثال
- Domain: `admin`; navigation group: `admin_org`
- Route: switchPage('risk_compliance') / views/risk_compliance.html
- Page type: PAGE

# 2. Business Purpose

Risk compliance — compliance (risk: high, phase: phase6b)
...
User opens this page to work with the Risk Compliance workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/risk_compliance.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/risk_compliance.html
...
- UI → renderer: views/risk_compliance.html
...
The intended output is the page’s named Risk Compliance record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: المخاطر والامتثال
- English label: Risk Compliance
...
- Canonical candidate: `risk_compliance` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `risk_compliance` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Risk Compliance workflow; the current 231/231 click audit is route activation evidence only.
...
- Risk Compliance workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

(function () {
  ...
  const PAGE_METADATA = {
    ...
    module_pack_center: { sensitivity: 'admin/modules', riskLevel: 'critical', phase: 'fpc-2', label: 'Module & Pack Center' },
    customization_studio: { sensitivity: 'admin/customization', riskLevel: 'high', phase: 'fpc-2', label: 'Customization Studio' },
    commercial_control_center: { sensitivity: 'admin/commercial', riskLevel: 'critical', phase: 'fpc-2', label: 'Commercial Control Center' },
    organization_center: { sensitivity: 'admin/org', riskLevel: 'high', phase: 'fpc-2', label: 'Organization Center' },
    identity_center: { sensitivity: 'admin/identity', riskLevel: 'critical', phase: 'fpc-2', label: 'Identity Center' },
    permission_center: { sensitivity: 'admin/permissions', riskLevel: 'critical', phase: 'fpc-2', label: 'Permission Center' },
    authority_governance: { sensitivity: 'admin/governance', riskLevel: 'critical', phase: 'fpc-2', label: 'Authority Governance' },
    workflow_studio: { sensitivity: 'admin/workflow', riskLevel: 'high', phase: 'fpc-2', label: 'Workflow Studio' },
    approval_policy_studio: { sensitivity: 'admin/approvals', riskLevel: 'critical', phase: 'fpc-2', label: 'Approval Policy Studio' },
    automation_rules: { sensitivity: 'admin/automation', riskLevel: 'high', phase: 'fpc-2', label: 'Automation Rules' },
    configuration_center: { sensitivity: 'admin/configuration', riskLevel: 'critical', phase: 'fpc-2', label: 'Configuration Center' },
    data_import_center: { sensitivity: 'admin/import', riskLevel: 'high', phase: 'fpc-2', label: 'Data Import Center' },
    audit_security_center: { sensitivity: 'admin/audit', riskLevel: 'critical', phase: 'fpc-2', label: 'Audit & Security Center' },
    release_health: { sensitivity: 'admin/release', riskLevel: 'high', phase: 'fpc-2', label: 'Release Health' },
    release_upgrade_center: { sensitivity: 'admin/release', riskLevel: 'critical', phase: 'fpc-2', label: 'Release & Upgrade Center' },
  ...
  const PAGE_PERMISSIONS = {
    ...
    module_pack_center: ['system.admin', 'workshop.manager', 'finance.manager'],
    customization_studio: ['system.admin', 'workshop.manager'],
    commercial_control_center: ['system.admin', 'finance.manager'],
    organization_center: ['system.admin', 'workshop.manager', 'finance.manager'],
    identity_center: ['system.admin'],
    permission_center: ['system.admin'],
    authority_governance: ['system.admin'],
    workflow_studio: ['system.admin', 'workshop.manager'],
    approval_policy_studio: ['system.admin', 'workshop.manager', 'finance.manager'],
    automation_rules: ['system.admin', 'workshop.manager'],
    configuration_center: ['system.admin'],
    data_import_center: ['system.admin', 'workshop.manager'],
    audit_security_center: ['system.admin'],
    release_health: ['system.admin', 'workshop.manager'],
    release_upgrade_center: ['system.admin'],

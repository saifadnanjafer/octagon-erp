...
page_id: "wfl_home"
title_en: "Wfl Home"
title_ar: "الرئيسية حسب الدور"
domain: "core"
navigation_group: "core_daily"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "wfl_home"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/wfl_home.html"]
view_sources: ["views/wfl_home.html"]
api_sources: []
...
- Page ID: `wfl_home`
- English: Wfl Home
- Arabic: الرئيسية حسب الدور
- Domain: `core`; navigation group: `core_daily`
- Route: switchPage('wfl_home') / views/wfl_home.html
- Page type: PAGE

# 2. Business Purpose

Role Home — employee_self_service (risk: low, phase: phase6h)
...
User opens this page to work with the Wfl Home workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/wfl_home.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/wfl_home.html
...
- UI → renderer: views/wfl_home.html
...
The intended output is the page’s named Wfl Home record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: الرئيسية حسب الدور
- English label: Wfl Home
...
- Canonical candidate: `wfl_home` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `wfl_home` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Wfl Home workflow; the current 231/231 click audit is route activation evidence only.
...
- Wfl Home workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

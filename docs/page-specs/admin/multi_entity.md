---
page_id: "multi_entity"
title_en: "Multi Entity"
title_ar: "الفروع والعملات"
domain: "admin"
navigation_group: "admin_org"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "multi_entity"
parent_page: null
aliases: []
roles: ["system.admin"]
...
renderer_type: "view"
renderer_sources: ["views/multi_entity.html"]
view_sources: ["views/multi_entity.html"]
api_sources: []
...
- Page ID: `multi_entity`
- English: Multi Entity
- Arabic: الفروع والعملات
- Domain: `admin`; navigation group: `admin_org`
- Route: switchPage('multi_entity') / views/multi_entity.html
- Page type: PAGE

# 2. Business Purpose

Multi-entity control — admin/tenant (risk: critical, phase: phase6e)
...
User opens this page to work with the Multi Entity workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/multi_entity.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/multi_entity.html
...
- UI → renderer: views/multi_entity.html
...
The intended output is the page’s named Multi Entity record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: الفروع والعملات
- English label: Multi Entity
...
- Canonical candidate: `multi_entity` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `multi_entity` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Multi Entity workflow; the current 231/231 click audit is route activation evidence only.
...
- Multi Entity workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

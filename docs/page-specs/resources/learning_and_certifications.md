---
page_id: "learning_and_certifications"
title_en: "Learning & Certifications"
title_ar: "التعلم والشهادات"
domain: "resources"
navigation_group: "resources_people"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "learning_and_certifications"
parent_page: null
aliases: []
...
- Page ID: `learning_and_certifications`
- English: Learning & Certifications
- Arabic: التعلم والشهادات
- Domain: `resources`; navigation group: `resources_people`
- Route: switchPage('learning_and_certifications') / views/learning_and_certifications.html
- Page type: PAGE

# 2. Business Purpose

Learning and certifications — build12/learning (risk: medium, phase: build12)
...
User opens this page to work with the Learning & Certifications workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/learning_and_certifications.html. Static source counts at baseline: 2 headings, 3 button tags, 2 input/select/textarea controls, 1 tables, 1 forms, and 2 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Learning & Certifications record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: التعلم والشهادات
- English label: Learning & Certifications
...
The Learning & Certifications workspace should give its governed users a page-specific way to complete the named business task: load scoped records, accept governed inputs where needed, execute authorized actions, persist the resulting state through the domain authority, and expose explicit loading/empty/denied/validation/server-error/success states. Exact fields and lifecycle transitions remain **NOT VERIFIED** where the baseline source does not define them.

# 17. Identified Gaps

- **PAGE-learning_and_certifications-GAP-004** (P1, PERMISSION) — The review inventory flags this commercial/SaaS page as lacking a matching entitlement mapping in the disposable review database.
- **PAGE-learning_and_certifications-GAP-005** (P2, TEST) — Documentation contradiction: NAVIGATION_FORENSIC_REPORT.json records app.js switchPage, while the module registry also contains this page. Reconcile renderer ownership after Product Recovery.
...
- Canonical candidate: `learning_and_certifications` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `learning_and_certifications` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Learning & Certifications workflow; the current 231/231 click audit is route activation evidence only.
...
- Learning & Certifications workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

---
page_id: "commercial_plans"
title_en: "Commercial Plans"
title_ar: "الخطط التجارية"
domain: "commercial"
navigation_group: "commercial_saas"
kind: SETUP
canonical_status: PRIMARY
canonical_home: "commercial_plans"
parent_page: null
aliases: []
...
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-11/admin-workspaces-contract.test.mjs","tests/build-11/build11r-acceptance-contract.test.mjs"]
...
- Page ID: `commercial_plans`
- English: Commercial Plans
- Arabic: الخطط التجارية
- Domain: `commercial`; navigation group: `commercial_saas`
- Route: switchPage('commercial_plans') / views/commercial_plans.html
- Page type: SETUP

# 2. Business Purpose

Commercial plans — commercial/plans (risk: high, phase: build11)
...
User opens this page to work with the Commercial Plans workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/commercial_plans.html. Static source counts at baseline: 5 headings, 6 button tags, 7 input/select/textarea controls, 1 tables, 1 forms, and 2 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Commercial Plans record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: الخطط التجارية
- English label: Commercial Plans
...
- Canonical candidate: `commercial_plans` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `commercial_plans` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Commercial Plans workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-11/admin-workspaces-contract.test.mjs, tests/build-11/build11r-acceptance-contract.test.mjs
...
- Commercial Plans workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

---
page_id: "omni_communications"
title_en: "Omni Communications"
title_ar: "مشاركة وإرسال"
domain: "commercial"
navigation_group: "commercial_relationships"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "omni_communications"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/omni_communications.html"]
view_sources: ["views/omni_communications.html"]
api_sources: []
...
- Page ID: `omni_communications`
- English: Omni Communications
- Arabic: مشاركة وإرسال
- Domain: `commercial`; navigation group: `commercial_relationships`
- Route: switchPage('omni_communications') / views/omni_communications.html
- Page type: PAGE

# 2. Business Purpose

Omni communications — ai/customer_comms (risk: high, phase: phase7j)
...
User opens this page to work with the Omni Communications workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/omni_communications.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/omni_communications.html
...
- UI → renderer: views/omni_communications.html
...
The intended output is the page’s named Omni Communications record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: مشاركة وإرسال
- English label: Omni Communications
...
- Canonical candidate: `omni_communications` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `omni_communications` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Omni Communications workflow; the current 231/231 click audit is route activation evidence only.
...
- `views/omni_communications.html`
- `index.html`
...
- Omni Communications workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

...
- Page ID: `count_session`
- English: Count Session
- Arabic: جلسة الجرد
- Domain: `ops`; navigation group: `ops_warehouse_fulfillment`
- Route: switchPage('count_session') / views/count_session.html
- Page type: PAGE

# 2. Business Purpose

Count session — workshop/inventory (risk: high, phase: build09)
...
User opens this page to work with the Count Session workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/count_session.html. Static source counts at baseline: 9 headings, 10 button tags, 3 input/select/textarea controls, 0 tables, 3 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Count Session record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.

# 10. Workflow Position

- Upstream: NOT VERIFIED from explicit workflow metadata.
- Downstream: `cycle_count_plans`, `variance_review`
...
- Arabic label: جلسة الجرد
- English label: Count Session
...
- Canonical candidate: `count_session` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `count_session` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Count Session workflow; the current 231/231 click audit is route activation evidence only.
...
- Count Session workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

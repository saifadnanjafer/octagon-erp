...
page_id: "nl_reports"
title_en: "Nl Reports"
title_ar: "التقارير الذكية"
domain: "intelligence"
navigation_group: "intelligence_core"
kind: ANALYTICS
canonical_status: PRIMARY
canonical_home: "nl_reports"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/nl_reports.html"]
view_sources: ["views/nl_reports.html"]
api_sources: []
...
- Page ID: `nl_reports`
- English: Nl Reports
- Arabic: التقارير الذكية
- Domain: `intelligence`; navigation group: `intelligence_core`
- Route: switchPage('nl_reports') / views/nl_reports.html
- Page type: ANALYTICS

# 2. Business Purpose

Natural language reports — manager/reporting (risk: medium, phase: core)
...
User opens this page to work with the Nl Reports workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/nl_reports.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/nl_reports.html
...
- UI → renderer: views/nl_reports.html
...
The intended output is the page’s named Nl Reports record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: التقارير الذكية
- English label: Nl Reports
...
- Canonical candidate: `nl_reports` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `nl_reports` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Nl Reports workflow; the current 231/231 click audit is route activation evidence only.
...
- Nl Reports workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

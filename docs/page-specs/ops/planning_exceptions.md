---
page_id: "planning_exceptions"
title_en: "Planning Exceptions"
title_ar: "· استثناءات التخطيط"
domain: "ops"
navigation_group: "ops_planning"
kind: QUEUE
canonical_status: PRIMARY
canonical_home: "planning_exceptions"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/planning_exceptions.html"]
view_sources: ["views/planning_exceptions.html"]
api_sources: []
...
- Page ID: `planning_exceptions`
- English: Planning Exceptions
- Arabic: · استثناءات التخطيط
- Domain: `ops`; navigation group: `ops_planning`
- Route: switchPage('planning_exceptions') / views/planning_exceptions.html
- Page type: QUEUE

# 2. Business Purpose

Planning exceptions — planning (risk: high, phase: build08)
...
User opens this page to work with the Planning Exceptions workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/planning_exceptions.html. Static source counts at baseline: 1 headings, 0 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/planning_exceptions.html
...
- UI → renderer: views/planning_exceptions.html
...
The intended output is the page’s named Planning Exceptions record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: · استثناءات التخطيط
- English label: Planning Exceptions
...
- Canonical candidate: `planning_exceptions` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `planning_exceptions` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Planning Exceptions workflow; the current 231/231 click audit is route activation evidence only.
...
- `views/planning_exceptions.html`
- `index.html`
...
- Planning Exceptions workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

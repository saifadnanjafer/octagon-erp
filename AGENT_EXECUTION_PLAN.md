...
3. Finance UI tabs (journal-entry UI only — `FinanceService` core stays where it lives)
4. Admin wire-up cluster
5. Automation engine
6. Op-packs, QC center, SOP, kanban, cashbox… continue down `MASTER_ROADMAP.md`'s module inventory.

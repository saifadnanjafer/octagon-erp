...
entitlement: "page:home (found in saas_plan_entitlements)"
renderer_type: "view"
renderer_sources: ["views/home.html"]
view_sources: ["views/home.html"]
api_sources: []
domain_sources: ["services/permissionService.js"]
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/phase02/browser-evidence.test.mjs","tests/phase02/browser-live-evidence.test.mjs","tests/phase02/runtime-adversarial.test.mjs","tests/phase02/security-suite.test.mjs","tests/phase03/finance-browser-evidence.test.mjs"]
...
- Route: switchPage('home') / views/home.html
- Page type: PAGE

# 2. Business Purpose

Home dashboard — system/home (risk: low, phase: core)
...
User opens this page to work with the Home workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/home.html. Static source counts at baseline: 0 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/home.html
...
The intended output is the page’s named Home record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Canonical candidate: `home` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `home` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Home workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/phase02/browser-evidence.test.mjs, tests/phase02/browser-live-evidence.test.mjs, tests/phase02/runtime-adversarial.test.mjs, tests/phase02/security-suite.test.mjs, tests/phase03/finance-browser-evidence.test.mjs
...
- Home workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

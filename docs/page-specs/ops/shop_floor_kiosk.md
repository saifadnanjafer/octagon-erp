---
page_id: "shop_floor_kiosk"
title_en: "Shop Floor Kiosk"
title_ar: "كشك أرضية الإنتاج"
domain: "ops"
navigation_group: "ops_kiosks"
kind: KIOSK
canonical_status: PRIMARY
canonical_home: "shop_floor_kiosk"
parent_page: null
aliases: []
roles: ["workshop.user"]
...
- Page ID: `shop_floor_kiosk`
- English: Shop Floor Kiosk
- Arabic: كشك أرضية الإنتاج
- Domain: `ops`; navigation group: `ops_kiosks`
- Route: switchPage('shop_floor_kiosk') / views/shop_floor_kiosk.html
- Page type: KIOSK

# 2. Business Purpose

Shop floor kiosk — kiosk/shopfloor (risk: medium, phase: build10)
...
User opens this page to work with the Shop Floor Kiosk workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/shop_floor_kiosk.html. Static source counts at baseline: 8 headings, 9 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 6 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Shop Floor Kiosk record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: كشك أرضية الإنتاج
- English label: Shop Floor Kiosk
...
- Canonical candidate: `shop_floor_kiosk` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `shop_floor_kiosk` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Shop Floor Kiosk workflow; the current 231/231 click audit is route activation evidence only.

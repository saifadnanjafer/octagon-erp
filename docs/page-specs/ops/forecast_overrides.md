---
page_id: "forecast_overrides"
title_en: "Forecast Overrides"
title_ar: "· تعديلات التنبؤ"
domain: "ops"
navigation_group: "ops_planning"
kind: ANALYTICS
canonical_status: PRIMARY
canonical_home: "forecast_overrides"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/forecast_overrides.html"]
view_sources: ["views/forecast_overrides.html"]
api_sources: []
...
- Page ID: `forecast_overrides`
- English: Forecast Overrides
- Arabic: · تعديلات التنبؤ
- Domain: `ops`; navigation group: `ops_planning`
- Route: switchPage('forecast_overrides') / views/forecast_overrides.html
- Page type: ANALYTICS

# 2. Business Purpose

Forecast overrides — planning (risk: high, phase: build08)
...
User opens this page to work with the Forecast Overrides workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/forecast_overrides.html. Static source counts at baseline: 1 headings, 0 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/forecast_overrides.html
...
- UI → renderer: views/forecast_overrides.html
...
The intended output is the page’s named Forecast Overrides record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: · تعديلات التنبؤ
- English label: Forecast Overrides
...
- Canonical candidate: `forecast_overrides` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `forecast_overrides` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Forecast Overrides workflow; the current 231/231 click audit is route activation evidence only.
...
- Forecast Overrides workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

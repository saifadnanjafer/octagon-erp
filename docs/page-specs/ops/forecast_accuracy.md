---
page_id: "forecast_accuracy"
title_en: "Forecast Accuracy"
title_ar: "· دقة التنبؤ"
domain: "ops"
navigation_group: "ops_planning"
kind: ANALYTICS
canonical_status: PRIMARY
canonical_home: "forecast_accuracy"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/forecast_accuracy.html"]
view_sources: ["views/forecast_accuracy.html"]
api_sources: []
...
- Page ID: `forecast_accuracy`
- English: Forecast Accuracy
- Arabic: · دقة التنبؤ
- Domain: `ops`; navigation group: `ops_planning`
- Route: switchPage('forecast_accuracy') / views/forecast_accuracy.html
- Page type: ANALYTICS

# 2. Business Purpose

Forecast accuracy — planning (risk: medium, phase: build08)
...
User opens this page to work with the Forecast Accuracy workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/forecast_accuracy.html. Static source counts at baseline: 1 headings, 0 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/forecast_accuracy.html
...
- UI → renderer: views/forecast_accuracy.html
...
The intended output is the page’s named Forecast Accuracy record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: · دقة التنبؤ
- English label: Forecast Accuracy
...
- Canonical candidate: `forecast_accuracy` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `forecast_accuracy` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Forecast Accuracy workflow; the current 231/231 click audit is route activation evidence only.
...
- Forecast Accuracy workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

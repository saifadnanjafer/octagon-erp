---
page_id: "ai_prompt_templates"
title_en: "AI Prompt Templates"
title_ar: "قوالب أوامر الذكاء الاصطناعي"
domain: "intelligence"
navigation_group: "intelligence_governance"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "ai_prompt_templates"
parent_page: null
aliases: []
...
- Page ID: `ai_prompt_templates`
- English: AI Prompt Templates
- Arabic: قوالب أوامر الذكاء الاصطناعي
- Domain: `intelligence`; navigation group: `intelligence_governance`
- Route: switchPage('ai_prompt_templates') / views/ai_prompt_templates.html
- Page type: PAGE

# 2. Business Purpose

AI prompt templates — build12/ai-tasks (risk: medium, phase: build12)
...
User opens this page to work with the AI Prompt Templates workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/ai_prompt_templates.html. Static source counts at baseline: 2 headings, 3 button tags, 2 input/select/textarea controls, 1 tables, 1 forms, and 2 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named AI Prompt Templates record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: قوالب أوامر الذكاء الاصطناعي
- English label: AI Prompt Templates
...
- **PAGE-ai_prompt_templates-GAP-004** (P1, PERMISSION) — The review inventory flags this commercial/SaaS page as lacking a matching entitlement mapping in the disposable review database.
- **PAGE-ai_prompt_templates-GAP-005** (P2, TEST) — Documentation contradiction: NAVIGATION_FORENSIC_REPORT.json records app.js switchPage, while the module registry also contains this page. Reconcile renderer ownership after Product Recovery.
...
- Canonical candidate: `ai_prompt_templates` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `ai_prompt_templates` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named AI Prompt Templates workflow; the current 231/231 click audit is route activation evidence only.
...
- AI Prompt Templates workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

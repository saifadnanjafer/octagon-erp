---
page_id: "device_health_center"
title_en: "Device Health Center"
title_ar: "مركز صحة الأجهزة"
domain: "resources"
navigation_group: "resources_devices"
kind: DASHBOARD
canonical_status: PRIMARY
canonical_home: "device_health_center"
parent_page: null
aliases: []
roles: ["workshop.user"]
...
- Page ID: `device_health_center`
- English: Device Health Center
- Arabic: مركز صحة الأجهزة
- Domain: `resources`; navigation group: `resources_devices`
- Route: switchPage('device_health_center') / views/device_health_center.html
- Page type: DASHBOARD

# 2. Business Purpose

Device health center — iot/health (risk: medium, phase: build10)
...
User opens this page to work with the Device Health Center workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/device_health_center.html. Static source counts at baseline: 6 headings, 5 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 6 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Device Health Center record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: مركز صحة الأجهزة
- English label: Device Health Center
...
- Canonical candidate: `device_health_center` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `device_health_center` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Device Health Center workflow; the current 231/231 click audit is route activation evidence only.
...
- Device Health Center workspace presentation and its explicitly verified page-specific actions: ${pageKey}:view, ${pageKey}:edit, ${pageKey}:create, OctagonBuild10.exportCsv(, ${pageKey}:view.

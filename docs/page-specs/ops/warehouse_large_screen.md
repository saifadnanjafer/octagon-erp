---
page_id: "warehouse_large_screen"
title_en: "Warehouse Large Screen"
title_ar: "شاشة المستودع الكبيرة"
domain: "ops"
navigation_group: "ops_boards"
kind: DASHBOARD
canonical_status: PRIMARY
canonical_home: "warehouse_large_screen"
parent_page: null
aliases: []
...
- Page ID: `warehouse_large_screen`
- English: Warehouse Large Screen
- Arabic: شاشة المستودع الكبيرة
- Domain: `ops`; navigation group: `ops_boards`
- Route: switchPage('warehouse_large_screen') / views/warehouse_large_screen.html
- Page type: DASHBOARD

# 2. Business Purpose

Warehouse large screen — boards/warehouse (risk: low, phase: build10)
...
User opens this page to work with the Warehouse Large Screen workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/warehouse_large_screen.html. Static source counts at baseline: 7 headings, 5 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 6 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Warehouse Large Screen record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: شاشة المستودع الكبيرة
- English label: Warehouse Large Screen
...
- Canonical candidate: `warehouse_large_screen` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `warehouse_large_screen` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Warehouse Large Screen workflow; the current 231/231 click audit is route activation evidence only.
...
- Warehouse Large Screen workspace presentation and its explicitly verified page-specific actions: ${pageKey}:view, ${pageKey}:edit, ${pageKey}:create, OctagonBuild10.exportCsv(, ${pageKey}:view.

---
page_id: "mps_proposals"
title_en: "Mps Proposals"
title_ar: "· مقترحات الإنتاج"
domain: "ops"
navigation_group: "ops_planning"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "mps_proposals"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/mps_proposals.html"]
view_sources: ["views/mps_proposals.html"]
api_sources: []
domain_sources: ["services/permissionService.js"]
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-08/build08-page-contract.test.mjs","tests/build-08/planning-browser-chromium.test.mjs"]
...
- Page ID: `mps_proposals`
- English: Mps Proposals
- Arabic: · مقترحات الإنتاج
- Domain: `ops`; navigation group: `ops_planning`
- Route: switchPage('mps_proposals') / views/mps_proposals.html
- Page type: PAGE

# 2. Business Purpose

MPS proposals — planning/production (risk: high, phase: build08)
...
User opens this page to work with the Mps Proposals workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/mps_proposals.html. Static source counts at baseline: 1 headings, 0 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/mps_proposals.html
...
- UI → renderer: views/mps_proposals.html
...
The intended output is the page’s named Mps Proposals record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: · مقترحات الإنتاج
- English label: Mps Proposals
...
- Canonical candidate: `mps_proposals` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `mps_proposals` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Mps Proposals workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-08/build08-page-contract.test.mjs, tests/build-08/planning-browser-chromium.test.mjs
...
- Mps Proposals workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

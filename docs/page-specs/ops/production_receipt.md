---
page_id: "production_receipt"
title_en: "Production Receipt"
title_ar: "استلام الإنتاج"
domain: "ops"
navigation_group: "ops_production"
kind: TRANSACTION
canonical_status: PRIMARY
canonical_home: "production_receipt"
parent_page: null
aliases: []
roles: ["workshop.user"]
...
renderer_sources: ["modules/build09-action-forms.js"]
view_sources: []
api_sources: []
domain_sources: ["modules/build09-action-forms.js","services/permissionService.js","modules/build09-production-material-workspaces.js"]
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-09/build09-workspaces-contract.test.mjs","tests/build-09/build09r2-bespoke-contract.test.mjs","tests/build-09/cross-domain-lifecycles.test.mjs","tests/build-09/operational-32-page-matrix-chromium.test.mjs","tests/build-09/production-material-flow-domain.test.mjs","tests/build-09/production-material-workspaces-browser.test.mjs","tests/build-09/production-material-workspaces-contract.test.mjs","tests/workshop/pilot-full-lifecycle.test.mjs"]
...
- Page ID: `production_receipt`
- English: Production Receipt
- Arabic: استلام الإنتاج
- Domain: `ops`; navigation group: `ops_production`
- Route: switchPage('production_receipt') / views/production_receipt.html
- Page type: TRANSACTION

# 2. Business Purpose

Production receipt — workshop/production (risk: high, phase: build09)
...
User opens this page to work with the Production Receipt workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/production_receipt.html. Static source counts at baseline: 5 headings, 7 button tags, 9 input/select/textarea controls, 0 tables, 2 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: modules/build09-action-forms.js
...
- UI → renderer: modules/build09-action-forms.js
...
The intended output is the page’s named Production Receipt record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.

# 10. Workflow Position

- Upstream: NOT VERIFIED from explicit workflow metadata.
- Downstream: `lot_serial_traceability`, `production_issue_return`, `production_material_requests`
...
- Arabic label: استلام الإنتاج
- English label: Production Receipt
...
- Canonical candidate: `production_receipt` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `production_receipt` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Production Receipt workflow; the current 231/231 click audit is route activation evidence only.
...
- Production Receipt workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

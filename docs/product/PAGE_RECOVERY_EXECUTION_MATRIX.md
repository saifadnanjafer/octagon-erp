...
| `knowledge` | `resources/knowledge.md` | ALIAS | RECLASSIFIED | CONSOLIDATE — alias to canonical `knowledge_base` | `app.js`, `index.html`, `docs/navigation/NAVIGATION_FORENSIC_REPORT.json` | `npm.cmd run test:page-consolidation` | PASS |
| `geofence_events` | `resources/geofence.md` | TAB | RECLASSIFIED | CONSOLIDATE — tab under canonical `geofence_management` | `app.js`, `index.html`, `docs/navigation/NAVIGATION_FORENSIC_REPORT.json` | `npm.cmd run test:page-consolidation` | PASS |
| `consolidation_lineage` | `finance/consolidation.md` | TAB | RECLASSIFIED | CONSOLIDATE — tab under canonical `consolidation_groups` | `app.js`, `index.html`, `docs/navigation/NAVIGATION_FORENSIC_REPORT.json` | `npm.cmd run test:page-consolidation` | PASS |
| `consolidation_runs` | `finance/consolidation.md` | TAB | RECLASSIFIED | CONSOLIDATE — tab under canonical `consolidation_groups` | `app.js`, `index.html`, `docs/navigation/NAVIGATION_FORENSIC_REPORT.json` | `npm.cmd run test:page-consolidation` | PASS |
| `forecast_accuracy` | `ops/planning.md` | TAB | RECLASSIFIED | CONSOLIDATE — tab under canonical `forecast_overrides` | `app.js`, `index.html`, `docs/navigation/NAVIGATION_FORENSIC_REPORT.json` | `npm.cmd run test:page-consolidation` | PASS |
| `forecast_versions` | `ops/planning.md` | TAB | RECLASSIFIED | CONSOLIDATE — tab under canonical `forecast_overrides` | `app.js`, `index.html`, `docs/navigation/NAVIGATION_FORENSIC_REPORT.json` | `npm.cmd run test:page-consolidation` | PASS |
| `device_enrollment` | `resources/devices.md` | TAB | RECLASSIFIED | CONSOLIDATE — tab under canonical `device_registry` | `app.js`, `index.html`, `docs/navigation/NAVIGATION_FORENSIC_REPORT.json` | `npm.cmd run test:page-consolidation` | PASS |
| `replenishment_rules` | `ops/wms.md` | TAB | RECLASSIFIED | CONSOLIDATE — tab under canonical `putaway_rules` | `app.js`, `index.html`, `docs/navigation/NAVIGATION_FORENSIC_REPORT.json` | `npm.cmd run test:page-consolidation` | PASS |
| `receiving_discrepancies` | `ops/wms.md` | TAB | RECLASSIFIED | CONSOLIDATE — tab under canonical `mobile_receiving` | `app.js`, `index.html`, `docs/navigation/NAVIGATION_FORENSIC_REPORT.json` | `npm.cmd run test:page-consolidation` | PASS |
| `mps_proposals` | `ops/planning.md` | TAB | RECLASSIFIED | CONSOLIDATE — tab under canonical `mps` | `app.js`, `index.html`, `docs/navigation/NAVIGATION_FORENSIC_REPORT.json` | `npm.cmd run test:page-consolidation` | PASS |

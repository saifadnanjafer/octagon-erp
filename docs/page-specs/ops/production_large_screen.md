---
page_id: "production_large_screen"
title_en: "Production Large Screen"
title_ar: "شاشة الإنتاج الكبيرة"
domain: "ops"
navigation_group: "ops_boards"
kind: DASHBOARD
canonical_status: PRIMARY
canonical_home: "production_large_screen"
parent_page: null
aliases: []
...
- Page ID: `production_large_screen`
- English: Production Large Screen
- Arabic: شاشة الإنتاج الكبيرة
- Domain: `ops`; navigation group: `ops_boards`
- Route: switchPage('production_large_screen') / views/production_large_screen.html
- Page type: DASHBOARD

# 2. Business Purpose

Production large screen — boards/production (risk: low, phase: build10)
...
User opens this page to work with the Production Large Screen workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/production_large_screen.html. Static source counts at baseline: 7 headings, 5 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 6 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Production Large Screen record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: شاشة الإنتاج الكبيرة
- English label: Production Large Screen
...
- Canonical candidate: `production_large_screen` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `production_large_screen` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Production Large Screen workflow; the current 231/231 click audit is route activation evidence only.
...
- Production Large Screen workspace presentation and its explicitly verified page-specific actions: ${pageKey}:view, ${pageKey}:edit, ${pageKey}:create, OctagonBuild10.exportCsv(, ${pageKey}:view.

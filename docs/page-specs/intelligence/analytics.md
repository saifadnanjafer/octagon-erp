...
page_id: "analytics"
title_en: "Analytics"
title_ar: "التحليلات والذكاء"
domain: "intelligence"
navigation_group: "intelligence_core"
kind: ANALYTICS
canonical_status: PRIMARY
canonical_home: "analytics"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/analytics.html"]
view_sources: ["views/analytics.html"]
api_sources: []
...
- Page ID: `analytics`
- English: Analytics
- Arabic: التحليلات والذكاء
- Domain: `intelligence`; navigation group: `intelligence_core`
- Route: switchPage('analytics') / views/analytics.html
- Page type: ANALYTICS

# 2. Business Purpose

Analytics — manager/reporting (risk: medium, phase: core)
...
User opens this page to work with the Analytics workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/analytics.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/analytics.html
...
- UI → renderer: views/analytics.html
...
The intended output is the page’s named Analytics record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: التحليلات والذكاء
- English label: Analytics
...
- Canonical candidate: `analytics` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `analytics` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Analytics workflow; the current 231/231 click audit is route activation evidence only.
...
- Analytics workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

...
title_ar: "قاعدة المعرفة (الفنية)"
domain: "resources"
navigation_group: "resources_knowledge"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "knowledge_base"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/knowledge_base.html"]
view_sources: ["views/knowledge_base.html"]
api_sources: []
...
- Page ID: `knowledge_base`
- English: Knowledge Base
- Arabic: قاعدة المعرفة (الفنية)
- Domain: `resources`; navigation group: `resources_knowledge`
- Route: switchPage('knowledge_base') / views/knowledge_base.html
- Page type: PAGE

# 2. Business Purpose

Knowledge Base & FAQ — workshop/operations (risk: low, phase: phase8d)
...
User opens this page to work with the Knowledge Base workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/knowledge_base.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/knowledge_base.html
...
- UI → renderer: views/knowledge_base.html
...
The intended output is the page’s named Knowledge Base record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: قاعدة المعرفة (الفنية)
- English label: Knowledge Base
...
- Canonical candidate: `knowledge_base` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `knowledge_base` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Knowledge Base workflow; the current 231/231 click audit is route activation evidence only.
...
- Knowledge Base workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

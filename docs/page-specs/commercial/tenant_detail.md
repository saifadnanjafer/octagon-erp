---
page_id: "tenant_detail"
title_en: "Tenant Detail"
title_ar: "تفاصيل المستأجر"
domain: "commercial"
navigation_group: "commercial_saas"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "tenant_detail"
parent_page: null
aliases: []
...
- Page ID: `tenant_detail`
- English: Tenant Detail
- Arabic: تفاصيل المستأجر
- Domain: `commercial`; navigation group: `commercial_saas`
- Route: switchPage('tenant_detail') / views/tenant_detail.html
- Page type: PAGE

# 2. Business Purpose

Tenant detail — commercial/tenant (risk: high, phase: build11)
...
User opens this page to work with the Tenant Detail workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/tenant_detail.html. Static source counts at baseline: 5 headings, 6 button tags, 7 input/select/textarea controls, 1 tables, 1 forms, and 2 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Tenant Detail record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: تفاصيل المستأجر
- English label: Tenant Detail
...
- Canonical candidate: `tenant_detail` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `tenant_detail` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Tenant Detail workflow; the current 231/231 click audit is route activation evidence only.
...
- Tenant Detail workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

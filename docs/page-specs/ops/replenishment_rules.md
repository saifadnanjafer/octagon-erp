---
page_id: "replenishment_rules"
title_en: "Replenishment Rules"
title_ar: "قواعد التجديد"
domain: "ops"
navigation_group: "ops_warehouse_inbound"
kind: SETUP
canonical_status: PRIMARY
canonical_home: "replenishment_rules"
parent_page: null
aliases: []
...
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-09/build09-workspaces-contract.test.mjs","tests/build-09/build09r2-bespoke-contract.test.mjs","tests/build-09/operational-32-page-matrix-chromium.test.mjs","tests/build-09/putaway-workspaces-browser.test.mjs"]
...
- Page ID: `replenishment_rules`
- English: Replenishment Rules
- Arabic: قواعد التجديد
- Domain: `ops`; navigation group: `ops_warehouse_inbound`
- Route: switchPage('replenishment_rules') / views/replenishment_rules.html
- Page type: SETUP

# 2. Business Purpose

Replenishment rules — workshop/inventory (risk: high, phase: build09)
...
User opens this page to work with the Replenishment Rules workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/replenishment_rules.html. Static source counts at baseline: 15 headings, 15 button tags, 0 input/select/textarea controls, 0 tables, 9 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Replenishment Rules record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.

# 10. Workflow Position

- Upstream: NOT VERIFIED from explicit workflow metadata.
- Downstream: `putaway_rules`, `putaway_task_queue`, `replenishment_proposals`
...
- Arabic label: قواعد التجديد
- English label: Replenishment Rules
...
- Canonical candidate: `replenishment_rules` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `replenishment_rules` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Replenishment Rules workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-09/build09-workspaces-contract.test.mjs, tests/build-09/build09r2-bespoke-contract.test.mjs, tests/build-09/operational-32-page-matrix-chromium.test.mjs, tests/build-09/putaway-workspaces-browser.test.mjs
...
- Replenishment Rules workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

...
page_id: "qc_center"
title_en: "Qc Center"
title_ar: "مركز الجودة"
domain: "ops"
navigation_group: "ops_inventory"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "qc_center"
parent_page: null
aliases: []
roles: ["workshop.user"]
...
renderer_type: "view"
renderer_sources: ["views/qc_center.html"]
view_sources: ["views/qc_center.html"]
api_sources: []
...
- Route: switchPage('qc_center') / views/qc_center.html
- Page type: PAGE

# 2. Business Purpose

QC center — workshop/quality (risk: medium, phase: core)
...
User opens this page to work with the Qc Center workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/qc_center.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/qc_center.html
...
- UI → renderer: views/qc_center.html
...
The intended output is the page’s named Qc Center record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: مركز الجودة
- English label: Qc Center
...
- Canonical candidate: `qc_center` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `qc_center` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Qc Center workflow; the current 231/231 click audit is route activation evidence only.
...
- Qc Center workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

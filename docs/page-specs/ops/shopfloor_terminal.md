...
title_en: "Shop-Floor Terminal"
title_ar: "محطة أرضية الإنتاج"
domain: "ops"
...
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-09/build09-workspaces-contract.test.mjs","tests/build-09/build09r2-bespoke-contract.test.mjs","tests/build-09/operational-32-page-matrix-chromium.test.mjs","tests/build-09/operational-production-quality-chromium.test.mjs","tests/build-09/shopfloor-workspaces-browser.test.mjs"]
...
- Page ID: `shopfloor_terminal`
- English: Shop-Floor Terminal
- Arabic: محطة أرضية الإنتاج
- Domain: `ops`; navigation group: `ops_production`
- Route: switchPage('shopfloor_terminal') / views/shopfloor_terminal.html
- Page type: PAGE

# 2. Business Purpose

Shop-floor terminal — workshop/production (risk: high, phase: build09)
...
User opens this page to work with the Shop-Floor Terminal workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/shopfloor_terminal.html. Static source counts at baseline: 7 headings, 8 button tags, 0 input/select/textarea controls, 0 tables, 3 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Shop-Floor Terminal record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.

# 10. Workflow Position

- Upstream: NOT VERIFIED from explicit workflow metadata.
- Downstream: `workcenter_queue`
...
- Arabic label: محطة أرضية الإنتاج
- English label: Shop-Floor Terminal
...
- Canonical candidate: `shopfloor_terminal` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `shopfloor_terminal` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Shop-Floor Terminal workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-09/build09-workspaces-contract.test.mjs, tests/build-09/build09r2-bespoke-contract.test.mjs, tests/build-09/operational-32-page-matrix-chromium.test.mjs, tests/build-09/operational-production-quality-chromium.test.mjs, tests/build-09/shopfloor-workspaces-browser.test.mjs
...
- Shop-Floor Terminal workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

...
page_id: "ai_tools"
title_en: "Ai Tools"
title_ar: "سجل أدوات الذكاء"
domain: "intelligence"
navigation_group: "intelligence_ai"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "ai_tools"
parent_page: null
aliases: []
roles: ["system.admin"]
...
renderer_type: "view"
renderer_sources: ["views/ai_tools.html"]
view_sources: ["views/ai_tools.html"]
api_sources: []
...
- Page ID: `ai_tools`
- English: Ai Tools
- Arabic: سجل أدوات الذكاء
- Domain: `intelligence`; navigation group: `intelligence_ai`
- Route: switchPage('ai_tools') / views/ai_tools.html
- Page type: PAGE

# 2. Business Purpose

AI tools — ai/system (risk: critical, phase: phase6e)
...
User opens this page to work with the Ai Tools workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/ai_tools.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/ai_tools.html
...
- UI → renderer: views/ai_tools.html
...
The intended output is the page’s named Ai Tools record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: سجل أدوات الذكاء
- English label: Ai Tools
...
- Canonical candidate: `ai_tools` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `ai_tools` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Ai Tools workflow; the current 231/231 click audit is route activation evidence only.
...
- Ai Tools workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

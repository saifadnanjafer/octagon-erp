...
page_id: "marketing"
title_en: "Marketing"
title_ar: "التسويق والحملات"
domain: "commercial"
navigation_group: "commercial_marketing"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "marketing"
parent_page: null
aliases: []
roles: ["workshop.user"]
...
renderer_sources: ["views/marketing.html","modules/build12-workspaces.js"]
view_sources: ["views/marketing.html"]
...
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-08/planning-finance-lifecycle.test.mjs","tests/build-12/build12-acceptance-contract.test.mjs","tests/build-12/build12-browser.test.mjs","tests/build-12/build12-domain.test.mjs","tests/review/review-environment.test.mjs"]
...
- Page ID: `marketing`
- English: Marketing
- Arabic: التسويق والحملات
- Domain: `commercial`; navigation group: `commercial_marketing`
- Route: switchPage('marketing') / views/marketing.html
- Page type: PAGE

# 2. Business Purpose

Marketing — workshop/operations (risk: medium, phase: phase6h)
...
User opens this page to work with the Marketing workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/marketing.html. Static source counts at baseline: 3 headings, 3 button tags, 2 input/select/textarea controls, 1 tables, 1 forms, and 2 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/marketing.html
...
- UI → renderer: views/marketing.html
...
The intended output is the page’s named Marketing record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: التسويق والحملات
- English label: Marketing
...
- Canonical candidate: `marketing` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `marketing` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Marketing workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-08/planning-finance-lifecycle.test.mjs, tests/build-12/build12-acceptance-contract.test.mjs, tests/build-12/build12-browser.test.mjs, tests/build-12/build12-domain.test.mjs, tests/review/review-environment.test.mjs
...
- Marketing workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

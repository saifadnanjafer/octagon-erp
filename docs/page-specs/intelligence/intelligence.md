...
title_ar: "لوحة الذكاء"
domain: "intelligence"
navigation_group: "intelligence_core"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "intelligence"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/intelligence.html"]
view_sources: ["views/intelligence.html"]
api_sources: []
domain_sources: ["services/permissionService.js"]
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-13/navigation-architecture.test.mjs"]
...
- Page ID: `intelligence`
- English: Intelligence
- Arabic: لوحة الذكاء
- Domain: `intelligence`; navigation group: `intelligence_core`
- Route: switchPage('intelligence') / views/intelligence.html
- Page type: PAGE

# 2. Business Purpose

AI intelligence — ai/system (risk: high, phase: core)
...
User opens this page to work with the Intelligence workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/intelligence.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/intelligence.html
...
- UI → renderer: views/intelligence.html
...
The intended output is the page’s named Intelligence record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: لوحة الذكاء
- English label: Intelligence
...
- Canonical candidate: `intelligence` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `intelligence` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Intelligence workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-13/navigation-architecture.test.mjs
...
- Intelligence workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

---
page_id: "demand_planning"
title_en: "Demand Planning"
title_ar: "· تخطيط الطلب"
domain: "ops"
navigation_group: "ops_planning"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "demand_planning"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/demand_planning.html"]
view_sources: ["views/demand_planning.html"]
api_sources: []
...
- Page ID: `demand_planning`
- English: Demand Planning
- Arabic: · تخطيط الطلب
- Domain: `ops`; navigation group: `ops_planning`
- Route: switchPage('demand_planning') / views/demand_planning.html
- Page type: PAGE

# 2. Business Purpose

Demand planning — planning (risk: high, phase: build08)
...
User opens this page to work with the Demand Planning workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/demand_planning.html. Static source counts at baseline: 1 headings, 0 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/demand_planning.html
...
- UI → renderer: views/demand_planning.html
...
The intended output is the page’s named Demand Planning record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: · تخطيط الطلب
- English label: Demand Planning
...
- **PAGE-demand_planning-GAP-002** (P1, ACTION) — No meaningful primary action path was verified in the inspected source.
- **PAGE-demand_planning-GAP-003** (P1, API) — No literal backend API path was verified in the inspected page-specific source; server capability remains NOT VERIFIED.
...
- Canonical candidate: `demand_planning` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `demand_planning` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Demand Planning workflow; the current 231/231 click audit is route activation evidence only.
...
- Demand Planning workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

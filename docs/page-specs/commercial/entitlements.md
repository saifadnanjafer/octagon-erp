---
page_id: "entitlements"
title_en: "Entitlements"
title_ar: "الاستحقاقات"
domain: "commercial"
navigation_group: "commercial_saas"
kind: SETUP
canonical_status: PRIMARY
canonical_home: "entitlements"
parent_page: null
aliases: []
...
renderer_sources: ["views/entitlements.html","modules/build11-workspaces.js"]
view_sources: ["views/entitlements.html"]
api_sources: ["/api/v1/service/policies","/api/v1/saas/${path}${queryString","/api/v1/action/${actionId}"]
domain_sources: ["services/permissionService.js","modules/build11-workspaces.js"]
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-07/service-browser-chromium.test.mjs","tests/build-07/service-entitlement-signature-lifecycle.test.mjs","tests/build-11/admin-workspaces-contract.test.mjs","tests/build-11/build11r-acceptance-contract.test.mjs","tests/build-11/commercial-platform-browser.test.mjs"]
...
- Page ID: `entitlements`
- English: Entitlements
- Arabic: الاستحقاقات
- Domain: `commercial`; navigation group: `commercial_saas`
- Route: switchPage('entitlements') / views/entitlements.html
- Page type: SETUP

# 2. Business Purpose

Entitlements — commercial/entitlements (risk: high, phase: build11)
...
User opens this page to work with the Entitlements workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/entitlements.html. Static source counts at baseline: 6 headings, 6 button tags, 7 input/select/textarea controls, 2 tables, 1 forms, and 3 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/entitlements.html
...
- UI → renderer: views/entitlements.html
- Renderer → API/query: /api/v1/service/policies, /api/v1/saas/${path}${queryString, /api/v1/action/${actionId}
...
The intended output is the page’s named Entitlements record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.

# 10. Workflow Position

- Upstream: NOT VERIFIED from explicit workflow metadata.
- Downstream: `events`, `subscriptions`
...
- Arabic label: الاستحقاقات
- English label: Entitlements
...
- Canonical candidate: `entitlements` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `entitlements` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Entitlements workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-07/service-browser-chromium.test.mjs, tests/build-07/service-entitlement-signature-lifecycle.test.mjs, tests/build-11/admin-workspaces-contract.test.mjs, tests/build-11/build11r-acceptance-contract.test.mjs, tests/build-11/commercial-platform-browser.test.mjs
...
- Entitlements workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

(function governedLookups(root) {
  'use strict';
  const cache = new Map();
  const resources = Object.freeze({ warehouses: 'warehouses', zones: 'zones', locations: 'locations', products: 'products', variants: 'product-variants', lots: 'lots', serials: 'serials', receivingSessions: 'receiving-sessions', pickTasks: 'pick-tasks', waves: 'waves', countPlans: 'count-plans', countSessions: 'count-sessions', docks: 'docks', productionOrders: 'production-orders', workOrders: 'work-orders', workCenters: 'work-centers', operators: 'operators', qualityCheckpoints: 'quality-checkpoints', dispositions: 'quality-dispositions' });

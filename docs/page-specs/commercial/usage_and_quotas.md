---
page_id: "usage_and_quotas"
title_en: "Usage and Quotas"
title_ar: "الاستخدام والحصص"
domain: "commercial"
navigation_group: "commercial_saas"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "usage_and_quotas"
parent_page: null
aliases: []
...
- Page ID: `usage_and_quotas`
- English: Usage and Quotas
- Arabic: الاستخدام والحصص
- Domain: `commercial`; navigation group: `commercial_saas`
- Route: switchPage('usage_and_quotas') / views/usage_and_quotas.html
- Page type: PAGE

# 2. Business Purpose

Usage and quotas — commercial/usage (risk: high, phase: build11)
...
User opens this page to work with the Usage and Quotas workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/usage_and_quotas.html. Static source counts at baseline: 5 headings, 6 button tags, 7 input/select/textarea controls, 1 tables, 1 forms, and 2 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Usage and Quotas record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: الاستخدام والحصص
- English label: Usage and Quotas
...
- Canonical candidate: `usage_and_quotas` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `usage_and_quotas` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Usage and Quotas workflow; the current 231/231 click audit is route activation evidence only.
...
- Usage and Quotas workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED, NOT VERIFIED.

...
page_id: "ai_factory"
title_en: "Ai Factory"
title_ar: "مصنع التطوير"
domain: "intelligence"
navigation_group: "intelligence_ai"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "ai_factory"
parent_page: null
aliases: []
roles: ["system.admin"]
...
renderer_type: "view"
renderer_sources: ["views/ai_factory.html"]
view_sources: ["views/ai_factory.html"]
api_sources: []
...
- Route: switchPage('ai_factory') / views/ai_factory.html
- Page type: PAGE

# 2. Business Purpose

AI factory — ai/system (risk: critical, phase: phase6e)
...
User opens this page to work with the Ai Factory workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/ai_factory.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/ai_factory.html
...
- UI → renderer: views/ai_factory.html
...
The intended output is the page’s named Ai Factory record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: مصنع التطوير
- English label: Ai Factory
...
- Canonical candidate: `ai_factory` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `ai_factory` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Ai Factory workflow; the current 231/231 click audit is route activation evidence only.
...
- Ai Factory workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

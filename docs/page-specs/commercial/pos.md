...
renderer_type: "view"
renderer_sources: ["views/pos.html"]
view_sources: ["views/pos.html"]
api_sources: []
domain_sources: ["services/permissionService.js"]
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-01/rma-foundation.test.mjs","tests/build-05/platform-services-lifecycle.test.mjs","tests/build-06/commercial-operations-lifecycle.test.mjs","tests/build-07/mdg-dq-lifecycle.test.mjs","tests/build-08/browser-harness.mjs","tests/build-08/build08-page-contract.test.mjs","tests/build-08/group-finance-browser-chromium.test.mjs","tests/build-08/intercompany-operations-domain.test.mjs"]
...
- Route: switchPage('pos') / views/pos.html
- Page type: PAGE

# 2. Business Purpose

Point of Sale — workshop/pos (risk: medium, phase: phase6h)
...
User opens this page to work with the Pos workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/pos.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/pos.html
...
The intended output is the page’s named Pos record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Canonical candidate: `pos` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `pos` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Pos workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-01/rma-foundation.test.mjs, tests/build-05/platform-services-lifecycle.test.mjs, tests/build-06/commercial-operations-lifecycle.test.mjs, tests/build-07/mdg-dq-lifecycle.test.mjs, tests/build-08/browser-harness.mjs, tests/build-08/build08-page-contract.test.mjs, tests/build-08/group-finance-browser-chromium.test.mjs, tests/build-08/intercompany-operations-domain.test.mjs
...
- Pos workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

...
renderer_type: "view"
renderer_sources: ["views/financing_facilities.html"]
...
- Page ID: `financing_facilities`
- English: Financing Facilities
- Arabic: · تسهيلات التمويل
- Domain: `finance`; navigation group: `finance_treasury`
- Route: switchPage('financing_facilities') / views/financing_facilities.html
- Page type: PAGE

# 2. Business Purpose

Financing facilities — finance/treasury (risk: high, phase: build08)
...
User opens this page to work with the Financing Facilities workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/financing_facilities.html. Static source counts at baseline: 1 headings, 0 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/financing_facilities.html
...
- UI → renderer: views/financing_facilities.html
...
The intended output is the page’s named Financing Facilities record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: · تسهيلات التمويل
- English label: Financing Facilities
...
- Canonical candidate: `financing_facilities` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `financing_facilities` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Financing Facilities workflow; the current 231/231 click audit is route activation evidence only.
...
- Financing Facilities workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

---
page_id: "treasury_cash_position"
title_en: "Treasury Cash Position"
title_ar: "· مركز النقد"
domain: "finance"
navigation_group: "finance_treasury"
kind: DASHBOARD
canonical_status: PRIMARY
canonical_home: "treasury_cash_position"
parent_page: null
aliases: []
roles: ["finance.user"]
...
renderer_type: "view"
renderer_sources: ["views/treasury_cash_position.html"]
view_sources: ["views/treasury_cash_position.html"]
api_sources: []
domain_sources: ["services/permissionService.js"]
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-08/build08-page-contract.test.mjs","tests/build-08/group-finance-browser-chromium.test.mjs","tests/build-08/platform-governance-contract.test.mjs"]
...
- Page ID: `treasury_cash_position`
- English: Treasury Cash Position
- Arabic: · مركز النقد
- Domain: `finance`; navigation group: `finance_treasury`
- Route: switchPage('treasury_cash_position') / views/treasury_cash_position.html
- Page type: DASHBOARD

# 2. Business Purpose

Treasury cash position — finance/treasury (risk: high, phase: build08)
...
User opens this page to work with the Treasury Cash Position workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/treasury_cash_position.html. Static source counts at baseline: 1 headings, 0 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/treasury_cash_position.html
...
- UI → renderer: views/treasury_cash_position.html
...
The intended output is the page’s named Treasury Cash Position record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: · مركز النقد
- English label: Treasury Cash Position
...
- Canonical candidate: `treasury_cash_position` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `treasury_cash_position` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Treasury Cash Position workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-08/build08-page-contract.test.mjs, tests/build-08/group-finance-browser-chromium.test.mjs, tests/build-08/platform-governance-contract.test.mjs
...
- `views/treasury_cash_position.html`
- `index.html`
...
- Treasury Cash Position workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

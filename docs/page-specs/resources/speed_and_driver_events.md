---
page_id: "speed_and_driver_events"
title_en: "Speed and Driver Events"
title_ar: "أحداث السرعة والسائق"
domain: "resources"
navigation_group: "resources_fleet"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "speed_and_driver_events"
parent_page: null
aliases: []
roles: ["workshop.user"]
...
- Page ID: `speed_and_driver_events`
- English: Speed and Driver Events
- Arabic: أحداث السرعة والسائق
- Domain: `resources`; navigation group: `resources_fleet`
- Route: switchPage('speed_and_driver_events') / views/speed_and_driver_events.html
- Page type: PAGE

# 2. Business Purpose

Speed and driver events — fleet/speed (risk: medium, phase: build10)
...
User opens this page to work with the Speed and Driver Events workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/speed_and_driver_events.html. Static source counts at baseline: 6 headings, 5 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 6 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Speed and Driver Events record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: أحداث السرعة والسائق
- English label: Speed and Driver Events
...
- Canonical candidate: `speed_and_driver_events` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `speed_and_driver_events` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Speed and Driver Events workflow; the current 231/231 click audit is route activation evidence only.
...
- Speed and Driver Events workspace presentation and its explicitly verified page-specific actions: ${pageKey}:view, ${pageKey}:edit, ${pageKey}:create, OctagonBuild10.exportCsv(, ${pageKey}:view.

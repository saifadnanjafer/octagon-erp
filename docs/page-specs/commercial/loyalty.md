...
renderer_type: "view"
renderer_sources: ["views/loyalty.html"]
view_sources: ["views/loyalty.html"]
api_sources: []
...
- Page ID: `loyalty`
- English: Loyalty
- Arabic: برنامج الولاء والمكافآت
- Domain: `commercial`; navigation group: `commercial_sales`
- Route: switchPage('loyalty') / views/loyalty.html
- Page type: PAGE

# 2. Business Purpose

Loyalty programs — workshop/operations (risk: medium, phase: phase6h)
...
User opens this page to work with the Loyalty workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/loyalty.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/loyalty.html
...
- UI → renderer: views/loyalty.html
...
The intended output is the page’s named Loyalty record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: برنامج الولاء والمكافآت
- English label: Loyalty
...
- Canonical candidate: `loyalty` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `loyalty` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Loyalty workflow; the current 231/231 click audit is route activation evidence only.
...
- Loyalty workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

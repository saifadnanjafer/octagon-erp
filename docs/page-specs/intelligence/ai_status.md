...
page_id: "ai_status"
title_en: "Ai Status"
title_ar: "حالة الذكاء الصناعي"
domain: "intelligence"
navigation_group: "intelligence_ai"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "ai_status"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/ai_status.html"]
view_sources: ["views/ai_status.html"]
api_sources: []
...
- Page ID: `ai_status`
- English: Ai Status
- Arabic: حالة الذكاء الصناعي
- Domain: `intelligence`; navigation group: `intelligence_ai`
- Route: switchPage('ai_status') / views/ai_status.html
- Page type: PAGE

# 2. Business Purpose

AI status — ai/system (risk: medium, phase: phase6e)
...
User opens this page to work with the Ai Status workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/ai_status.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/ai_status.html
...
- UI → renderer: views/ai_status.html
...
The intended output is the page’s named Ai Status record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: حالة الذكاء الصناعي
- English label: Ai Status
...
- Canonical candidate: `ai_status` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `ai_status` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Ai Status workflow; the current 231/231 click audit is route activation evidence only.
...
- Ai Status workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

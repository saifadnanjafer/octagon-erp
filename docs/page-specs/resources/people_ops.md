...
page_id: "people_ops"
title_en: "People Ops"
title_ar: "التوظيف والإجازات"
domain: "resources"
navigation_group: "resources_people"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "people_ops"
parent_page: null
aliases: []
...
renderer_type: "view"
renderer_sources: ["views/people_ops.html"]
view_sources: ["views/people_ops.html"]
api_sources: []
...
- Page ID: `people_ops`
- English: People Ops
- Arabic: التوظيف والإجازات
- Domain: `resources`; navigation group: `resources_people`
- Route: switchPage('people_ops') / views/people_ops.html
- Page type: PAGE

# 2. Business Purpose

People operations — hr/people (risk: high, phase: phase6e)
...
User opens this page to work with the People Ops workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/people_ops.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/people_ops.html
...
- UI → renderer: views/people_ops.html
...
The intended output is the page’s named People Ops record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: التوظيف والإجازات
- English label: People Ops
...
- Canonical candidate: `people_ops` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `people_ops` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named People Ops workflow; the current 231/231 click audit is route activation evidence only.
...
- People Ops workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

...
title_ar: "لوحة تحكم الأدمن"
domain: "admin"
navigation_group: "admin_org"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "admin_panel"
parent_page: null
aliases: []
roles: ["system.admin"]
...
renderer_type: "view"
renderer_sources: ["views/admin_panel.html"]
view_sources: ["views/admin_panel.html"]
api_sources: []
...
- Page ID: `admin_panel`
- English: Admin Panel
- Arabic: لوحة تحكم الأدمن
- Domain: `admin`; navigation group: `admin_org`
- Route: switchPage('admin_panel') / views/admin_panel.html
- Page type: PAGE

# 2. Business Purpose

Admin panel — admin/security (risk: critical, phase: core)
...
User opens this page to work with the Admin Panel workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/admin_panel.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/admin_panel.html
...
- UI → renderer: views/admin_panel.html
...
The intended output is the page’s named Admin Panel record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: لوحة تحكم الأدمن
- English label: Admin Panel
...
- Canonical candidate: `admin_panel` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `admin_panel` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Admin Panel workflow; the current 231/231 click audit is route activation evidence only.
...
- Admin Panel workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

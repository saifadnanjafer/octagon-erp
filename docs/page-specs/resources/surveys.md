...
page_id: "surveys"
title_en: "Surveys"
title_ar: "الاستبيانات والتقييمات"
domain: "resources"
navigation_group: "resources_knowledge"
kind: PAGE
canonical_status: PRIMARY
canonical_home: "surveys"
parent_page: null
aliases: []
roles: ["workshop.user"]
...
renderer_type: "view"
renderer_sources: ["views/surveys.html"]
view_sources: ["views/surveys.html"]
api_sources: []
...
- Page ID: `surveys`
- English: Surveys
- Arabic: الاستبيانات والتقييمات
- Domain: `resources`; navigation group: `resources_knowledge`
- Route: switchPage('surveys') / views/surveys.html
- Page type: PAGE

# 2. Business Purpose

Surveys — workshop/operations (risk: low, phase: phase6h)
...
User opens this page to work with the Surveys workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/surveys.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/surveys.html
...
- UI → renderer: views/surveys.html
...
The intended output is the page’s named Surveys record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: الاستبيانات والتقييمات
- English label: Surveys
...
- Canonical candidate: `surveys` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `surveys` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Surveys workflow; the current 231/231 click audit is route activation evidence only.
...
- Surveys workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.

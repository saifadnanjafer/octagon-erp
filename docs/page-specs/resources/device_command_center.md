---
page_id: "device_command_center"
title_en: "Device Command Center"
title_ar: "مركز أوامر الأجهزة"
domain: "resources"
navigation_group: "resources_devices"
kind: DASHBOARD
canonical_status: PRIMARY
canonical_home: "device_command_center"
parent_page: null
aliases: []
...
- Page ID: `device_command_center`
- English: Device Command Center
- Arabic: مركز أوامر الأجهزة
- Domain: `resources`; navigation group: `resources_devices`
- Route: switchPage('device_command_center') / views/device_command_center.html
- Page type: DASHBOARD

# 2. Business Purpose

Device command center — iot/commands (risk: critical, phase: build10)
...
User opens this page to work with the Device Command Center workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/device_command_center.html. Static source counts at baseline: 6 headings, 5 button tags, 1 input/select/textarea controls, 1 tables, 0 forms, and 6 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.
...
The intended output is the page’s named Device Command Center record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- Arabic label: مركز أوامر الأجهزة
- English label: Device Command Center
...
- Canonical candidate: `device_command_center` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `device_command_center` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Device Command Center workflow; the current 231/231 click audit is route activation evidence only.
...
- Device Command Center workspace presentation and its explicitly verified page-specific actions: ${pageKey}:view, ${pageKey}:edit, ${pageKey}:create, OctagonBuild10.exportCsv(, ${pageKey}:view.

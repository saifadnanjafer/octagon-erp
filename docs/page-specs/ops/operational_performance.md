...
view_sources: []
api_sources: []
domain_sources: ["modules/build09-downtime-workspace.js","services/permissionService.js"]
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-09/build09-workspaces-contract.test.mjs","tests/build-09/build09r2-bespoke-contract.test.mjs","tests/build-09/downtime-workspaces-browser.test.mjs","tests/build-09/operational-32-page-matrix-chromium.test.mjs"]
...
- Page ID: `operational_performance`
- English: Operational Performance
- Arabic: الأداء التشغيلي
- Domain: `ops`; navigation group: `ops_production`
- Route: switchPage('operational_performance') / views/operational_performance.html
- Page type: ANALYTICS

# 2. Business Purpose

Operational performance — workshop/production (risk: medium, phase: build09)
...
User opens this page to work with the Operational Performance workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/operational_performance.html. Static source counts at baseline: 6 headings, 2 button tags, 2 input/select/textarea controls, 0 tables, 1 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: modules/build09-downtime-workspace.js
...
- UI → renderer: modules/build09-downtime-workspace.js
...
The intended output is the page’s named Operational Performance record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.

# 10. Workflow Position

- Upstream: NOT VERIFIED from explicit workflow metadata.
- Downstream: `downtime_board`
...
- Arabic label: الأداء التشغيلي
- English label: Operational Performance
...
- Canonical candidate: `operational_performance` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `operational_performance` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Operational Performance workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-09/build09-workspaces-contract.test.mjs, tests/build-09/build09r2-bespoke-contract.test.mjs, tests/build-09/downtime-workspaces-browser.test.mjs, tests/build-09/operational-32-page-matrix-chromium.test.mjs
...
- Operational Performance workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED, NOT VERIFIED.

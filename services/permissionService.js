(function () {
  ...
  const PAGE_METADATA = {
    ...
    ai_overview: { sensitivity: 'build12/ai', riskLevel: 'medium', phase: 'build12', label: 'Governed AI overview' },
    ai_assistant: { sensitivity: 'build12/ai', riskLevel: 'high', phase: 'build12', label: 'Governed AI assistant' },
    ai_proposal_inbox: { sensitivity: 'build12/ai-proposals', riskLevel: 'high', phase: 'build12', label: 'AI proposal inbox' },
    ai_run_history: { sensitivity: 'build12/ai-runs', riskLevel: 'medium', phase: 'build12', label: 'AI run history' },
    ai_policy_registry: { sensitivity: 'build12/ai-policy', riskLevel: 'high', phase: 'build12', label: 'AI policy registry' },
    ai_prompt_templates: { sensitivity: 'build12/ai-tasks', riskLevel: 'medium', phase: 'build12', label: 'AI prompt templates' },
    ai_context_sources: { sensitivity: 'build12/ai-context', riskLevel: 'high', phase: 'build12', label: 'AI context sources' },
    people_development_overview: { sensitivity: 'build12/people', riskLevel: 'medium', phase: 'build12', label: 'People development' },
    skills_catalog: { sensitivity: 'build12/skills', riskLevel: 'medium', phase: 'build12', label: 'Skills catalog' },
    competency_profiles: { sensitivity: 'build12/competencies', riskLevel: 'medium', phase: 'build12', label: 'Competency profiles' },
    person_skill_evidence: { sensitivity: 'build12/evidence', riskLevel: 'high', phase: 'build12', label: 'Skill evidence' },
    development_plans: { sensitivity: 'build12/development-plans', riskLevel: 'high', phase: 'build12', label: 'Development plans' },
    learning_and_certifications: { sensitivity: 'build12/learning', riskLevel: 'medium', phase: 'build12', label: 'Learning and certifications' },
    marketing_overview: { sensitivity: 'build12/marketing', riskLevel: 'medium', phase: 'build12', label: 'Marketing overview' },
    campaigns: { sensitivity: 'build12/campaigns', riskLevel: 'high', phase: 'build12', label: 'Marketing campaigns' },
    content_calendar: { sensitivity: 'build12/content', riskLevel: 'medium', phase: 'build12', label: 'Content calendar' },
    content_approvals: { sensitivity: 'build12/content-review', riskLevel: 'high', phase: 'build12', label: 'Content approvals' },
    attribution_insights: { sensitivity: 'build12/attribution', riskLevel: 'low', phase: 'build12', label: 'Attribution insights' },
    events_overview: { sensitivity: 'build12/events', riskLevel: 'medium', phase: 'build12', label: 'Events overview' },
    event_planner: { sensitivity: 'build12/event-planner', riskLevel: 'high', phase: 'build12', label: 'Event planner' },
    event_registrations: { sensitivity: 'build12/registrations', riskLevel: 'medium', phase: 'build12', label: 'Event registrations' },
    event_checkin: { sensitivity: 'build12/checkin', riskLevel: 'high', phase: 'build12', label: 'Event check-in' },
    vertical_packs: { sensitivity: 'build12/packs', riskLevel: 'high', phase: 'build12', label: 'Vertical packs' },
    workshop_pack_setup: { sensitivity: 'build12/pack-installations', riskLevel: 'high', phase: 'build12', label: 'Workshop pack setup' }
  };
  ...
  const PAGE_PERMISSIONS = {
    ...
    ai_overview: ['system.admin', 'workshop.manager', 'finance.manager'],
    ai_assistant: ['system.admin', 'workshop.manager', 'finance.manager'],
    ai_proposal_inbox: ['system.admin', 'workshop.manager', 'finance.manager'],
    ai_run_history: ['system.admin', 'workshop.manager', 'finance.manager'],
    ai_policy_registry: ['system.admin', 'workshop.manager'],
    ai_prompt_templates: ['system.admin', 'workshop.manager'],
    ai_context_sources: ['system.admin', 'workshop.manager', 'finance.manager'],
    people_development_overview: ['system.admin', 'workshop.manager'],
    skills_catalog: ['system.admin', 'workshop.manager'],
    competency_profiles: ['system.admin', 'workshop.manager'],
    person_skill_evidence: ['system.admin', 'workshop.manager'],
    development_plans: ['system.admin', 'workshop.manager'],
    learning_and_certifications: ['system.admin', 'workshop.manager'],
    marketing_overview: ['system.admin', 'workshop.manager', 'finance.manager'],
    campaigns: ['system.admin', 'workshop.manager'],
    content_calendar: ['system.admin', 'workshop.manager'],
    content_approvals: ['system.admin', 'workshop.manager'],
    attribution_insights: ['system.admin', 'workshop.manager', 'finance.manager'],
    events_overview: ['system.admin', 'workshop.manager'],
    event_planner: ['system.admin', 'workshop.manager'],
    event_registrations: ['system.admin', 'workshop.manager'],
    event_checkin: ['system.admin', 'workshop.manager'],
    vertical_packs: ['system.admin', 'workshop.manager'],
    workshop_pack_setup: ['system.admin', 'workshop.manager']
  };

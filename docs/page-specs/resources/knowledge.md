...
renderer_type: "view"
renderer_sources: ["views/knowledge.html"]
view_sources: ["views/knowledge.html"]
api_sources: []
domain_sources: ["services/permissionService.js"]
tables_or_entities: []
test_sources: ["docs/navigation/NAVIGATION_FORENSIC_REPORT.json","docs/autopilot/evidence/NAVIGATION-RECOVERY-1-click-audit-all.json","tests/build-08/group-finance-browser-chromium.test.mjs","tests/build-08/treasury-liquidity-domain.test.mjs","tests/build-09/cross-domain-lifecycles.test.mjs","tests/build-09/downtime-workspaces-browser.test.mjs","tests/build-09/mobile-receiving-picking-browser.test.mjs","tests/build-09/operational-browser-chromium.test.mjs","tests/build-09/production-material-flow-domain.test.mjs","tests/build-09/production-material-workspaces-browser.test.mjs"]
...
- Route: switchPage('knowledge') / views/knowledge.html
- Page type: PAGE

# 2. Business Purpose

Knowledge Base — workshop/operations (risk: low, phase: phase6h)
...
User opens this page to work with the Knowledge workspace. The exact business completion goal is supported by the review inventory purpose statement above.

# 5. AS-IS Runtime Surface

The registered view is views/knowledge.html. Static source counts at baseline: 1 headings, 0 button tags, 0 input/select/textarea controls, 0 tables, 0 forms, and 0 literal /api/v1 calls. Dynamic content not visible in static source is NOT VERIFIED.

- Renderer evidence: views/knowledge.html
...
- UI → renderer: views/knowledge.html
...
The intended output is the page’s named Knowledge record, decision, view, or operational state. Exact persisted object: NOT VERIFIED.
...
- **PAGE-knowledge-GAP-002** (P1, ACTION) — No meaningful primary action path was verified in the inspected source.
- **PAGE-knowledge-GAP-003** (P1, API) — No literal backend API path was verified in the inspected page-specific source; server capability remains NOT VERIFIED.
...
- Canonical candidate: `knowledge` unless a later owner decision records another home.

# 19. Acceptance Criteria

- A user with the declared permission can open `knowledge` through the visible navigation and see a non-error page-specific surface.
...
- A scoped browser test proves the named Knowledge workflow; the current 231/231 click audit is route activation evidence only.
...
- **API / DOMAIN:** tests/build-08/group-finance-browser-chromium.test.mjs, tests/build-08/treasury-liquidity-domain.test.mjs, tests/build-09/cross-domain-lifecycles.test.mjs, tests/build-09/downtime-workspaces-browser.test.mjs, tests/build-09/mobile-receiving-picking-browser.test.mjs, tests/build-09/operational-browser-chromium.test.mjs, tests/build-09/production-material-flow-domain.test.mjs, tests/build-09/production-material-workspaces-browser.test.mjs
...
- Knowledge workspace presentation and its explicitly verified page-specific actions: NOT VERIFIED.
